...
class SearchStateHolder<T : Any>(
    ...
    private val responseGetter: suspend (String, Int) -> Result<com.example.sharedui.paging.UiPage<T>>
) {
    //
    ...
    //
    private val _searchPagingProvider =
        com.example.sharedui.paging.PagingProvider(::pageDateProvider)
    ...
    private suspend fun pageDateProvider(
        page: Int
    ): Result<com.example.sharedui.paging.UiPage<T>> {
